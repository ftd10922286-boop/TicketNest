    ...
    public class SupportAgentController : Controller
    {
        ...
        public async Task<IActionResult> PostSupportAgent([FromBody] SupportAgent supportAgent)
        {
            try
            {
                ...
                if (supportAgent.supportAgentId == Guid.Empty)
                {
                    ...
                    {
                        UserName = supportAgent.Email,
                        Email = supportAgent.Email,
                        FullName = supportAgent.supportAgentName
                    };
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        supportAgent.CreateBy = User.FindFirst(System.Security.Claims.ClaimTypes.NameIdentifier)?.Value;
        ...
        public async Task<IActionResult> DeleteSupportAgent([FromRoute] Guid id)
        {
            try
            {
                ...
                if (supportAgent == null) return NotFound();
